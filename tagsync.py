...
def main(selected: bool, _dry: bool, verbose: bool, clean: bool, update: bool, sync: bool, scan: list[str],
    ...
    try:
        ...
        if itunes is None:
            log.error("Unable to create iTunes COM object. iTunes may not be installed or not accessible.")
        else:
            log.info("Successfully connected to iTunes.")
    except Exception as e:
        log.error(f"Failed to connect to iTunes: {e}")
